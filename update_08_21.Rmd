...
2. On the ACM DL, I searched with `"shared virtual environment" AND "haptic" AND "virtual reality"`.
**Note:** I used shared virtual environment because it seemed to be a subset of remote collaboration. We can further discuss this part.
